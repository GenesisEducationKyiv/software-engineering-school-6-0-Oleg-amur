...
const (
	...
	SubscriptionService_Confirm_FullMethodName                             = "/subscriptions.v1.SubscriptionService/Confirm"
	SubscriptionService_Unsubscribe_FullMethodName                         = "/subscriptions.v1.SubscriptionService/Unsubscribe"
	SubscriptionService_GetSubscriptions_FullMethodName                    = "/subscriptions.v1.SubscriptionService/GetSubscriptions"
	SubscriptionService_ListActiveSubscriptionsByRepository_FullMethodName = "/subscriptions.v1.SubscriptionService/ListActiveSubscriptionsByRepository"
)
...
type SubscriptionServiceClient interface {
	...
	ListActiveSubscriptionsByRepository(ctx context.Context, in *ListActiveSubscriptionsByRepositoryRequest, opts ...grpc.CallOption) (*ListActiveSubscriptionsByRepositoryResponse, error)
}
...
func (c *subscriptionServiceClient) ListActiveSubscriptionsByRepository(ctx context.Context, in *ListActiveSubscriptionsByRepositoryRequest, opts ...grpc.CallOption) (*ListActiveSubscriptionsByRepositoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListActiveSubscriptionsByRepositoryResponse)
	err := c.cc.Invoke(ctx, SubscriptionService_ListActiveSubscriptionsByRepository_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SubscriptionServiceServer interface {
	...
	ListActiveSubscriptionsByRepository(context.Context, *ListActiveSubscriptionsByRepositoryRequest) (*ListActiveSubscriptionsByRepositoryResponse, error)
...
func (UnimplementedSubscriptionServiceServer) ListActiveSubscriptionsByRepository(context.Context, *ListActiveSubscriptionsByRepositoryRequest) (*ListActiveSubscriptionsByRepositoryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListActiveSubscriptionsByRepository not implemented")
}
...
func _SubscriptionService_ListActiveSubscriptionsByRepository_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListActiveSubscriptionsByRepositoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SubscriptionServiceServer).ListActiveSubscriptionsByRepository(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SubscriptionService_ListActiveSubscriptionsByRepository_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SubscriptionServiceServer).ListActiveSubscriptionsByRepository(ctx, req.(*ListActiveSubscriptionsByRepositoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SubscriptionService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListActiveSubscriptionsByRepository",
			Handler:    _SubscriptionService_ListActiveSubscriptionsByRepository_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "subscriptions/v1/subscription_service.proto",
}
